function validateForm() {
    ...
    if (name.trim() === '' || gender === '' || collegename.trim() === '' || branch.trim() === '' ||
        email.trim() === '' || phone.trim() === '' || dob === '' || username.trim() === '' ||
    ...
    if (!nameRegex.test(collegename)) {
      alert("College name should only contain letters and spaces.");
      return false;
    }
  
    if (!nameRegex.test(branch)) {
      alert("Branch should only contain letters and spaces.");
      return false;
    }
